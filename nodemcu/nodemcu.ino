...
const char* mqtt_server = "192.168.137.163";
...
String msg1, temp1, humi1, temp_ds1;
char msg[50], temp[50], humi[50], temp_ds[50];
...
if(strcmp(topic,"DHT11interval")==0){ // strcmp return 0 if true
    gettemperature();
    Serial.println(temp_c);
    dtostrf(temp_c , 2, 2, temp);//dtostrf(floatVar, minStringWidthIncDecimalPoint, numVarsAfterDecimal, charBuf);
    Serial.println(humidity);
    dtostrf(humidity , 2, 2, humi);
    Serial.println(temp_ds2);
   dtostrf(temp_ds2, 2, 2, temp_ds);

    temp_ds1= temp_ds;
    temp1 = temp;
    humi1 = humi;
    msg1 = temp1 + " " + humi1 + " " + temp_ds1;

    msg1.toCharArray(msg, 50);
    client.publish(outTopic1, msg);
}
if(strcmp(topic, "LEDin")==0){
  if(message == "1")
...
void gettemperature() {
  ...
  if(currentMillis - previousMillis >= interval) {
    ...
    temp_ds2 = DS18B20.getTempCByIndex(0);
